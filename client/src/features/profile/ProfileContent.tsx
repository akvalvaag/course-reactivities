...
function ProfileContent() {
    ...
    return (
        <Box component={Paper} sx={{mt: 2, p: 3, elevation: 3, height: 500, display: 'flex', alignItems: 'flex-start', borderRadius: 3}}>
            <Tabs orientation={'vertical'} value={value} onChange={handleChange} sx={{borderRight: 1, height: 450, minWidth: 200}}>
